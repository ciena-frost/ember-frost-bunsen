      ...
      describe('when expanded/opened', function () {
        ...
        describe('when first option selected', function () {
          beforeEach(function () {
            ...
            $hook('my-form-foo-item', {index: 0}).find('label').trigger('mousedown')
            return wait()
          })
      ...
      describe('when expanded/opened', function () {
        ...
        describe('when last option selected (initial value)', function () {
          beforeEach(function () {
            props.onChange.reset()
            props.onValidation.reset()
            $hook('my-form-foo-item', {index: 2}).find('label').trigger('mousedown')
            return wait()
          })
        ...
        describe('when first option selected', function () {
          ...
          it('renders as expected', function () {
            ...
            expectOnChangeState({props}, {foo: [42, 1]})
            expectOnValidationState({props}, {count: 1})
          })
        })
      })
