...
describeComponent(
  'frost-bunsen-form',
  'Integration: Component | frost-bunsen-form | array of integers',
  {
    integration: true
  },
  function () {
      ...
      describe('when autoAdd enabled', function () {
        ...
        describe('when user inputs integer', function () {
          ...
          describe('when user clears input', function () {
            beforeEach(function () {
              this.$(selectors.frost.number.input.enabled).first()
                .val('')
                .trigger('input')
            })
    ...
    describe('with initial value', function () {
      ...
      describe('when sortable enabled', function () {
        ...
        it('renders as expected', function () {
          expect(
            this.$(selectors.bunsen.renderer.number),
            'renders a bunsen integer input for each array item'
          )
            .to.have.length(2)
