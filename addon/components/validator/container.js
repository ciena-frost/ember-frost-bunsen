...
export default createFactory({
   ...
   */
  init: function (containers, model, renderers = []) {
   ...
   */
  _validateSubContainer: function (path, containerId, model) {
    const results = []
   ...
   */
  _validateCustomCell: function (path, cell) {
    const results = [
      {
        valid: true,
        errors: []
   ...
   * @returns {BunsenValidationResult} the results of the cell validation
   */
  _validateArrayCell: function (path, cell, model) {
    const results = []
    if (cell.container) {
   ...
   * @returns {BunsenValidationResult} the results of the cell validation
   */
  _validateModelCell: function (path, cell, subModel) {
    const results = []
   ...
   * @returns {BunsenValidationResult} the results of the cell validation
   */
  _validateDependentModelCell: function (path, cell, model) {
    const results = []
   ...
   * @returns {BunsenValidationResult} the results of the cell validation
   */
  _validateCell: function (path, cell, model) {
    const results = []
   ...
   */
  _validateRow: function (path, cells, model) {
    if (!_.isArray(cells)) {
      return {
        valid: false,
        errors: [
   ...
   */
  validate: function (path, container, model) {
